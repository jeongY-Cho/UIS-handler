...
let mockScreenStr = mockScreenArr.join("\n")
test("is screen", () => {
  expect(new Screen() instanceof Screen).toBe(true)
})

test("test Screen.set()", () => {
  let testScreen = new Screen()
